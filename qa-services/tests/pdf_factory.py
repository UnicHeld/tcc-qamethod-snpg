...
def image_only_pdf() -> bytes:
    drawing = b"q 100 0 0 100 72 600 cm /Im1 Do Q"
    objects = [
        b"<< /Type /Catalog /Pages 2 0 R >>",
        b"<< /Type /Pages /Kids [3 0 R] /Count 1 >>",
        (
...
def tabular_pdf() -> bytes:
    drawing_commands = [
        "72 720 m 432 720 l S",
        "72 680 m 432 680 l S",
        "72 640 m 432 640 l S",
        "72 600 m 432 600 l S",
        "72 560 m 432 560 l S",
        "72 560 m 72 720 l S",
        "252 560 m 252 720 l S",
        "432 560 m 432 720 l S",
    ]
    values = [
        (80, 694, "Indicador"),
        (260, 694, "Valor"),
    ...
    text_commands = [
        f"BT /F1 10 Tf 1 0 0 1 {x} {y} Tm ({text}) Tj ET"
        for x, y, text in values
    ]
    stream = "\n".join(drawing_commands + text_commands).encode("cp1252")
    objects = [
        b"<< /Type /Catalog /Pages 2 0 R >>",
        b"<< /Type /Pages /Kids [3 0 R] /Count 1 >>",
        (
